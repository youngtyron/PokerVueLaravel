...
class GameController extends Controller
{
    ...
    //                       'opponents'=>$game->playersArray($p->id), 'match_id'=>$game->id, 
    //                       'turn'=>$turn, 'call'=>$call_required, 'community'=>$communityarr, 'message'=>$message, 
    //                       'bet_type'=>$bet_type, 'previous'=>$previous, 'gamer'=>$p->id, 'loosers'=>$loosers);
    //       }
    //       event(new DeskCommonEvent($data));
    //     }
    //     if ($round->phase == 'shotdown'){
    ...
    //                       'opponents'=>$game->playersArray($player->id), 'match_id'=>$game->id, 
    //                       'turn'=>$turn, 'call'=>$call_required, 'community'=>$communityarr, 'message'=>$message, 
    //                       'bet_type'=>$bet_type, 'previous'=>$previous, 'gamer'=>$p->id, 'loosers'=>$loosers);
    //     }
    //     return $data;
